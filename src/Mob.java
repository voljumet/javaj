...
public class Mob extends MobsElement{
    ...
    public Mob(){
        ...
        else if (ContSetup.wave == 4){ mobHealth = 60; mobPayout =  4; PictureNumber = 4; mobDamage = 12; maxHealth =  60; }
        else if (ContSetup.wave == 5){ mobHealth = 110; mobPayout = 4; PictureNumber = 5; mobDamage = 14; maxHealth = 110; }
        else if (ContSetup.wave == 6){ mobHealth = 150; mobPayout = 4; PictureNumber = 6; mobDamage = 16; maxHealth = 150; }
